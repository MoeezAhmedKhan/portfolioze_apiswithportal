...
if($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC')
{
    ...
    $filewithnewname_of_profile = date("Ymdis")."CoverPhoto.".$profileType;
    ...
    if($profile_size <= 5000000) /*profile 5mb*/
    {
        ...
        {
             if(move_uploaded_file($profile_tmp,$target_dir.$filewithnewname_of_profile))
                  {
                     $insert = "UPDATE `users` SET `cover`='$filewithnewname_of_profile' WHERE `id`=$user_id";
